<template>
  <nav>
    ...
    >
      ...
      >FERMER</button>
      <div
        class="nav-bar nav-mobile"
        :style="{ height: showNavMobile ? '100vh' : '1px' }"
      >
        <ul>
...
export default {
  ...
  methods: {
    setTitleAnimation() {
      ...
      tlSpans.fromTo(spans, { margin: "0 3.5vw" }, { margin: "0 .7vw" });
      ...
      tlMobile.fromTo(
        ...
        {
          fontSize: "clamp(13px, 1.5vw, 100px)",
          width: "50%",
          left: "28%",
          y: "-10",
          position: "intial",
      ...
      tlSpansMobile.fromTo(spansMobile, { margin: "0 5vw" }, { margin: "0 2vw" });
    }
  }
};
</script>
...
.logo {
  ...
  top: 50px;
  left: 50vw;
  border: 0.1em solid rgba(0, 0, 0, 0.612);
}
nav ul {
  display: flex;
