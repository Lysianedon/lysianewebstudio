  ...
  <section>
    ...
    <div class="grid">
      <article class="art-1">
        <div class="content">
          <img
            src="../assets/logos/html-logo.png"
            alt="logo HTML"
          >
          <img
            src="../assets/logos/css-logo.png"
            alt="logo CSS"
          >
          <img
            src="../assets/logos/js-logo.png"
            alt="logo Javascript"
          >
        </div>
      ...
      <article class="art-3">
        <div class="content">
          ...
          >
          <img
            src="../assets/logos/vuetify-logo.png"
            alt="logo vuetify"
          >
          <img
            src="../assets/logos/buefy-logo.png"
            alt="logo buefy"
          >
          <img
          ...
          >
          <img
            src="../assets/logos/gsap-logo.png"
            alt="logo gsap"
          >
          <img
            src="../assets/logos/vite-logo.png"
            alt="logo vite"
          >
        </div>
        <div class="description">
      ...
      <article class="art-4">
        <div class="content">
          ...
          >
          <img
            src="../assets/logos/java-logo.png"
            alt="logo java"
          >
        </div>
        <div class="description">
      ...
      <article class="art-6">
        <div class="content">
          ...
          >
          <img
            src="../assets/logos/sequelize-logo.png"
            alt="logo sequelize"
          >
          <img
            src="../assets/logos/mariadb-logo.png"
            alt="logo mariadb"
          >
          <img
            src="../assets/logos/prisma-logo.png"
            alt="logo prisma"
          >
        </div>
        <div class="description">
